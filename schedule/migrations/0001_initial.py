...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schedule_calendarrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('schedule_eventrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('schedule_calendarrelation')

        # Deleting model 'Rule'
        db.delete_table('schedule_rule')

        # Deleting model 'Event'
        db.delete_table('schedule_event')

        # Deleting model 'EventRelation'
        db.delete_table('schedule_eventrelation')
